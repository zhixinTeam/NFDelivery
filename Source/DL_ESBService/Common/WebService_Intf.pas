...
const LibraryUID = '{1D43DEBA-A3C1-48DD-B10C-D615CF55AF1A}';
const TargetNamespace = 'WebService';
const IWebService_IID: TGUID = '{A8F54B97-BB49-4C31-9E13-192D00AA3B47}';
const WebService_EndPointURI = 'http://10.1.104.225:40274/soap';
type
  ...
  ['{a8f54b97-bb49-4c31-9e13-192d00aa3b47}']
    function credit(const data: WideString_Anonymous; const db: WideString_Anonymous; const login: UnicodeString; const password: UnicodeString): UnicodeString;
  ...
  ['{ac8e7ca2-9d2e-4cc2-90a5-3f92895b4e9c}']
    procedure Invoke_credit(const data: WideString_Anonymous; const db: WideString_Anonymous; const login: UnicodeString; const password: UnicodeString);
    ...
    function Retrieve_credit: UnicodeString;
  ...
  ['{e7b9d2ae-0413-4b0b-a227-81318241406b}']
    function Begincredit(const data: WideString_Anonymous; const db: WideString_Anonymous; const login: UnicodeString; const password: UnicodeString; const aCallback: TROAsyncCallback; const aUserData: Pointer = nil): IROAsyncRequest;
    ...
    function Endcredit(const aRequest: IROAsyncRequest): UnicodeString;
...
function TWebService_Proxy.credit(const data: WideString_Anonymous; const db: WideString_Anonymous; const login: UnicodeString; const password: UnicodeString): UnicodeString;
var
  lMessage: IROMessage;
...
begin
  ...
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_auth', 'remap_credit', 'remap_order', 'soapinputmessagenamespace', 'soapinputnameoverride', 
                                             'soapoutputmessagenamespace', 'style', 'type', 'use'], ['credit', '*', 'http://10.1.104.225:40274/soap', '*', 'auth', 'credit', 'order', 'tns', 'credit', 'tns', 
                                             'document', 'SOAP', 'literal']);
  try
    lMessage.InitializeRequestMessage(lTransportChannel, 'WebService', __InterfaceName, 'credit');
    lMessage.Write('data', System.TypeInfo(WideString_Anonymous), data, []);
    lMessage.Write('db', System.TypeInfo(WideString_Anonymous), db, []);
    ...
    lMessage.Read('creditResult', System.TypeInfo(UnicodeString), lResult, []);
  finally
...
begin
  ...
  lTransportChannel := __TransportChannel;
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_auth', 'remap_credit', 'remap_order', 'soapinputmessagenamespace', 'soapinputnameoverride', 
                                             'soapoutputmessagenamespace', 'style', 'type', 'use'], ['order', '*', 'http://10.1.104.225:40274/soap', '*', 'auth', 'credit', 'order', 'tns', 'order', 'tns', 
                                             'document', 'SOAP', 'literal']);
  try
...
begin
  ...
  lTransportChannel := __TransportChannel;
  lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_auth', 'remap_credit', 'remap_order', 'soapinputmessagenamespace', 'soapinputnameoverride', 
                                             'soapoutputmessagenamespace', 'style', 'type', 'use'], ['auth', '*', 'http://10.1.104.225:40274/soap', '*', 'auth', 'credit', 'order', 'tns', 'auth', 'tns', 
                                             'document', 'SOAP', 'literal']);
  try
...
procedure TWebService_AsyncProxy.Invoke_credit(const data: WideString_Anonymous; const db: WideString_Anonymous; const login: UnicodeString; const password: UnicodeString);
var
  lMessage: IROMessage;
  lTransportChannel: IROTransportChannel;
begin
  ...
  try
    ...
    lMessage.SetAttributes(lTransportChannel, ['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_auth', 'remap_credit', 'remap_order', 'soapinputmessagenamespace', 'soapinputnameoverride', 
                                               'soapoutputmessagenamespace', 'style', 'type', 'use'], ['credit', '*', 'http://10.1.104.225:40274/soap', '*', 'auth', 'credit', 'order', 'tns', 'credit', 
...
function TWebService_AsyncProxy.Retrieve_credit: UnicodeString;
var
  __response: TStream;
...
function TWebService_AsyncProxyEx.Begincredit(const data: WideString_Anonymous; const db: WideString_Anonymous; const login: UnicodeString; const password: UnicodeString; const aCallback: TROAsyncCallback; 
...
begin
  ...
  try
    lMessage.StoreAttributes2(['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_auth', 'remap_credit', 'remap_order', 'soapinputmessagenamespace', 'soapinputnameoverride', 
                               'soapoutputmessagenamespace', 'style', 'type', 'use'], ['credit', '*', 'http://10.1.104.225:40274/soap', '*', 'auth', 'credit', 'order', 'tns', 'credit', 'tns', 'document', 
                               'SOAP', 'literal']);
...
begin
  ...
  try
    lMessage.StoreAttributes2(['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_auth', 'remap_credit', 'remap_order', 'soapinputmessagenamespace', 'soapinputnameoverride', 
                               'soapoutputmessagenamespace', 'style', 'type', 'use'], ['order', '*', 'http://10.1.104.225:40274/soap', '*', 'auth', 'credit', 'order', 'tns', 'order', 'tns', 'document', 
                               'SOAP', 'literal']);
    lMessage.ApplyAttributes2();
    lMessage.InitializeRequestMessage(lTransportChannel, 'WebService', __InterfaceName, 'order');
    lMessage.Write('data', System.TypeInfo(UnicodeString), data, []);
...
begin
  ...
  try
    lMessage.StoreAttributes2(['action', 'inputchildrennamespace', 'location', 'outputchildrennamespace', 'remap_auth', 'remap_credit', 'remap_order', 'soapinputmessagenamespace', 'soapinputnameoverride', 
                               'soapoutputmessagenamespace', 'style', 'type', 'use'], ['auth', '*', 'http://10.1.104.225:40274/soap', '*', 'auth', 'credit', 'order', 'tns', 'auth', 'tns', 'document', 'SOAP', 
                               'literal']);
    lMessage.ApplyAttributes2();
    lMessage.InitializeRequestMessage(lTransportChannel, 'WebService', __InterfaceName, 'auth');
    lMessage.Write('db', System.TypeInfo(UnicodeString), db, []);
...
function TWebService_AsyncProxyEx.Endcredit(const aRequest: IROAsyncRequest): UnicodeString;
var
  lResult: UnicodeString;
begin
  aRequest.ReadResponse();
  aRequest.Message.Read('creditResult', System.TypeInfo(UnicodeString), lResult, []);
  result := lResult;
  exit;
end;
