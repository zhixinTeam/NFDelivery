...
begin
  ...
  try
    ...
    begin
      ...
      if not Assigned(FChannel) then
        FChannel := CoItfZxtoNcData.Create(FMsg, FHttp);
      FHttp.TargetUrl := gSysParam.FSrvRemote;
    end; //config web service channel
...
begin
    ...
    try
      ...
      begin
        ...
        begin
          ...
          nCreateTime := FieldByName('L_Date').AsString;
  ...
  try
    nStr := IItfZxtoNcData(FNCChannel^.FChannel).operationSaveorderTime(nStr,
