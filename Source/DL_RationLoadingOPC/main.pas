...
uses
  ...
  UMgrChannel, UChannelChooser, UMITPacker, ULibFun, UDataModule, USysConst;
        ...
        begin
          ...
          begin
            try
              ...
              on E: Exception do
              begin
                Memo1.Lines.Add('通道' + nTunnel + '停止称重失败,原因:' + e.Message);
              end;
            end;
            Exit;
          end;
          ...
          try
            ...
            on E: Exception do
            begin
              Memo1.Lines.Add('通道' + nTunnel + '启动称重失败,原因:' + e.Message);
            end;
          end;
        end;
      end;
