...
type
  ...
  TClientBusinessProvide = class(TClient2MITWorker)
  public
    function GetFlagStr(const nFlag: Integer): string; override;
    class function FunctionName: string; override;
  end;
  ...
  TClientBusinessHaulBack = class(TClient2MITWorker)
  public
    function GetFlagStr(const nFlag: Integer): string; override;
    class function FunctionName: string; override;
  end;
...
//------------------------------------------------------------------------------
class function TClientBusinessProvide.FunctionName: string;
begin
  Result := sCLI_BusinessProvide;
end;

function TClientBusinessProvide.GetFlagStr(const nFlag: Integer): string;
begin
  Result := inherited GetFlagStr(nFlag);

  case nFlag of
   cWorker_GetPackerName : Result := sBus_BusinessCommand;
   cWorker_GetMITName    : Result := sBus_BusinessProvide;
  end;
end;
...
//------------------------------------------------------------------------------
class function TClientBusinessHaulBack.FunctionName: string;
begin
  Result := sCLI_BusinessHaulback;
end;

function TClientBusinessHaulBack.GetFlagStr(const nFlag: Integer): string;
begin
  Result := inherited GetFlagStr(nFlag);

  case nFlag of
   cWorker_GetPackerName : Result := sBus_BusinessCommand;
   cWorker_GetMITName    : Result := sBus_BusinessHaulBack;
  end;
end;
...
initialization
  ...
  gBusinessWorkerManager.RegisteWorker(TClientBusinessHaulBack);
